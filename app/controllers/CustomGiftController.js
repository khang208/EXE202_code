...
class CartController {
  ...
  showCustomBox(req, res) {
    Box.find({})
      .lean()
      .then((boxs) => {
        //       console.log("Dữ liệu từ MongoDB:",boxs);
  ...
  showCustomConfirm(req, res) {
    res.render("customGift/customConfirmation");
  }
  ...
  async minus(req, res) {
    ...
    try {
      ...
      customBox.totalPrice =
        customBox.totalPrice.toLocaleString("vi-VN") + " VND";
